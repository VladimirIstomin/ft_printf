...
/*   Updated: 2021/10/17 18:59:36 by gmerlene         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	get_parameter_len(const void *obj, char type)
{
	if (type == 'c' || type == '%')
		...
		return (get_unsigned_len_in_notation((unsigned int *)obj, 10));
	else if (type == 'x' || type == 'X')
		return (get_unsigned_len_in_notation((unsigned int *)obj, 16));
	return (0);
}
